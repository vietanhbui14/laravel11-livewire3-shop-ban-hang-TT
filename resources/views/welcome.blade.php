        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl font-semibold text-black dark:text-white">Tài liệu</h2>

                                        <p class="mt-4 text-sm/relaxed">
                                            VA Shop có tài liệu tuyệt vời bao phủ mọi khía cạnh của framework.
                                            Dù bạn là người mới hay đã có kinh nghiệm với Laravel, chúng tôi
                                            khuyên bạn nên đọc tài liệu từ đầu đến cuối.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <a href="https://laracasts.com"
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    VA Shop cung cấp hàng nghìn bài hướng dẫn video về Laravel, PHP và JavaScript
                                    phát triển. Kiểm tra chúng, xem cho bản thân, và cải thiện kỹ năng phát triển
                                    trong quá trình.
                                </p>
                            </div>
                        ...
                        <a href="https://laravel-news.com"
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    VA Shop là một portal và newsletter tổng hợp tất cả các tin tức mới nhất và quan
                                    trọng nhất trong hệ sinh thái Laravel, bao gồm các bản cập nhật gói và hướng dẫn.
                                </p>
                            </div>
                        ...
                        <div
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Hệ sinh thái mạnh mẽ</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    VA Shop có thư viện mạnh mẽ của các công cụ và thư viện đầu tiên, chẳng hạn như <a
                                    ...
                                    giúp bạn đưa dự án của bạn lên cấp tiếp theo. Kết hợp chúng với các thư viện mạnh mẽ
                                    mã nguồn mở, chẳng hạn như <a href="https://laravel.com/docs/billing"
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    VA Shop v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
                </footer>
            </div>
        </div>
    </div>
