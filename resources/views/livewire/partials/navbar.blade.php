    ...
    <div class="relative md:flex md:items-center md:justify-between">
      <div class="flex items-center justify-between">
        <a wire:navigate
          ...
          href="/" aria-label="Brand">VA Shop</a>
        <div class="md:hidden">
          <button type="button"
      ...
      <div id="navbar-collapse-with-animation"
        ...
        <div
          ...
          <div
            ...
            <a wire:navigate
              class="font-medium {{ request()->routeIs('index') ? 'text-blue-600' : 'text-gray-500' }} py-3 md:py-6 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              href="{{ route('index') }}" aria-current="page">Trang chủ</a>

            <a wire:navigate
              class="font-medium {{ request()->routeIs('product-categories') ? 'text-blue-600' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              href="{{ route('product-categories') }}">
              Danh mục sản phẩm
            </a>

            <a wire:navigate
              class="font-medium {{ request()->routeIs('all-products') ? 'text-blue-600' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              href="{{ route('all-products') }}">
              Sản phẩm
            </a>

            <a wire:navigate
              class="font-medium flex items-center {{ request()->routeIs('cart-products') ? 'text-blue-600' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              href="{{ route('cart-products') }}">
              ...
              <span class="mr-1">Giỏ hàng</span> <span
