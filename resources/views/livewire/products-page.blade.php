      ...
      <div class="flex flex-wrap mb-24 -mx-3">
        <div class="w-full pr-2 lg:w-1/4 lg:block">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            <h2 class="text-2xl font-bold dark:text-gray-400">Thương hiệu</h2>
            <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
            <ul>
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            <h2 class="text-2xl font-bold dark:text-gray-400">Trạng thái sản phẩm</h2>
            <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
            <ul>
              ...
              <li class="mb-4">
                <label for="featured" class="flex items-center dark:text-gray-300">
                  ...
                  <span class="text-lg dark:text-gray-400">Sản phẩm nổi bật</span>
                </label>
              </li>
              ...
              <li class="mb-4">
                <label for="on_sale" class="flex items-center dark:text-gray-300">
                  ...
                  <span class="text-lg dark:text-gray-400">Sản phẩm giảm giá</span>
                </label>
              </li>
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div>
              ...
              <input type="range" wire:model.live="price_range"
                class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="5000000" value="0"
                step="1000">
              <div class="flex justify-between">
                <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(0, 'VND') }}</span>
                <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(5000000, 'VND')
                  }}</span>
              </div>
            </div>
          </div>
            ...
            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $product->id }}">
              <div class="border border-gray-300 dark:border-gray-700">
                ...
                <div class="p-3">
                  ...
                  <p class="text-lg">
                    <span class="text-green-600 dark:text-green-600">{{ Number::currency($product->price, 'VND',
                      locale:'vi') }}</span>
                  </p>
                </div>
                <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                  ...
                  <a wire:click.prevent='addToCart({{ $product->id }})' href="#"
                    ...
                    </svg><span wire:loading.remove wire:target='addToCart({{ $product->id }})'>Thêm vào giỏ hàng</span>
                    <span wire:loading wire:target='addToCart({{ $product->id }})'>Đang thêm vào giỏ hàng...</span>
                  </a>
