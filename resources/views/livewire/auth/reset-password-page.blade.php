      ...
      <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="p-4 sm:p-7">
          <div class="text-center">
            <h1 class="block text-2xl font-bold text-gray-800 dark:text-white"> Đặt lại mật khẩu</h1>
          </div>
            ...
            <form>
              <div class="grid gap-y-4">
                ...
                <div>
                  ...
                  <p class="hidden text-red-600 mt-2" id="password-error">Lỗi mật khẩu</p>
                </div>
                <!-- End Form Group -->

                <div>
                  <label for="password_confirmation" class="block text-sm mb-2 dark:text-white">Xác nhận mật
                    khẩu</label>
                  <div class="relative">
                  ...
                  <p class="text-xs text-red-600 mt-2" id="password_confirmation-error">Lỗi xác nhận mật khẩu</p>
                </div>
